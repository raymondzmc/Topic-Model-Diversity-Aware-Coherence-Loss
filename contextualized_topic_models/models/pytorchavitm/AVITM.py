...
from contextualized_topic_models.models.model import AbstractModel
from contextualized_topic_models.models.pytorchavitm import datasets
from contextualized_topic_models.models.pytorchavitm.avitm import avitm_model
...
class AVITM(AbstractModel):
    ...
    def __init__(self, num_topics=10, model_type='prodLDA', activation='softplus',
                 ...
                 use_partitions=False, use_npmi_loss=False, npmi_matrix=None, vocab_mask=None, 
        ...
        self.hyperparameters["use_npmi_loss"] = use_npmi_loss
        self.hyperparameters["npmi_matrix"] = npmi_matrix
        self.hyperparameters["vocab_mask"] = vocab_mask
        self.hyperparameters["use_glove_loss"] = use_glove_loss
        self.hyperparameters["word_vectors"] = word_vectors
    ...
    def set_params(self, hyperparameters):
        ...
        self.hyperparameters['use_npmi_loss'] = \
            hyperparameters.get('use_npmi_loss', self.hyperparameters['use_npmi_loss'])
        self.hyperparameters['npmi_matrix'] = \
            hyperparameters.get('npmi_matrix', self.hyperparameters['npmi_matrix'])
        self.hyperparameters['vocab_mask'] = \
            hyperparameters.get('vocab_mask', self.hyperparameters['vocab_mask'])
        self.hyperparameters['use_glove_loss'] = \
            hyperparameters.get('use_glove_loss', self.hyperparameters['use_glove_loss'])
        self.hyperparameters['word_vectors'] = \
            hyperparameters.get('word_vectors', self.hyperparameters['word_vectors'])
        self.hyperparameters['loss_weight'] = \
            hyperparameters.get('loss_weight', self.hyperparameters['loss_weight'])
